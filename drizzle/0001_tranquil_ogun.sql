DROP INDEX "programme_assignment_programmeId_studentId_key";--> statement-breakpoint
...
ALTER TABLE "festival_gallery_image" ALTER COLUMN "updatedAt" SET DEFAULT CURRENT_TIMESTAMP;--> statement-breakpoint
...
ALTER TABLE "student" ALTER COLUMN "updatedAt" SET DEFAULT CURRENT_TIMESTAMP;--> statement-breakpoint
...
CREATE UNIQUE INDEX "programme_assignment_programmeId_studentId_key" ON "programme_assignment" USING btree ("programmeId","studentId") WHERE "programme_assignment"."studentId" is not null;