...
ALTER TABLE "programme_team_lead" ADD CONSTRAINT "programme_team_lead_studentId_fkey" FOREIGN KEY ("studentId") REFERENCES "public"."student"("id") ON DELETE cascade ON UPDATE cascade;--> statement-breakpoint
...
CREATE INDEX "programme_team_lead_studentId_idx" ON "programme_team_lead" USING btree ("studentId");--> statement-breakpoint
