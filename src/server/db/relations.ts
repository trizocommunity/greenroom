...
import { user, passwordResetToken, payment, festival, programme, category, group, festivalMember, student, festivalNews, festivalGalleryImage, programmeAssignment, result, stage, scheduleEntry, userLoginEvent, userPurchaseSummary, festivalCategoryPreference, expiredFestivalResult, festivalLifecycleEvent, teamLeaderOtp, teamLeaderSession, programmeReportingSession, programmeReportedParticipant, programmeCodeLetter, programmeCodeLetterRecipient, programmeNotification, realtimeOutbox, programmeJudgeSession } from "./schema";
...
export const festivalGalleryImageRelations = relations(festivalGalleryImage, ({one}) => ({
	festival: one(festival, {
...
export const programmeAssignmentRelations = relations(programmeAssignment, ({one, many}) => ({
...
export const scheduleEntryRelations = relations(scheduleEntry, ({one, many}) => ({
	festival: one(festival, {
...
export const userPurchaseSummaryRelations = relations(userPurchaseSummary, ({one}) => ({
	user: one(user, {
...
export const festivalCategoryPreferenceRelations = relations(festivalCategoryPreference, ({one}) => ({
	user: one(user, {
...
export const expiredFestivalResultRelations = relations(expiredFestivalResult, ({one}) => ({
	festival: one(festival, {
...
export const festivalLifecycleEventRelations = relations(festivalLifecycleEvent, ({one}) => ({
	festival: one(festival, {
...
export const teamLeaderSessionRelations = relations(teamLeaderSession, ({one}) => ({
	student: one(student, {
...
export const programmeReportingSessionRelations = relations(programmeReportingSession, ({one, many}) => ({
	festival: one(festival, {
...
export const programmeReportedParticipantRelations = relations(programmeReportedParticipant, ({one}) => ({
...
export const programmeCodeLetterRecipientRelations = relations(programmeCodeLetterRecipient, ({one}) => ({
...
export const programmeCodeLetterRelations = relations(programmeCodeLetter, ({one, many}) => ({
	programmeCodeLetterRecipients: many(programmeCodeLetterRecipient),
	festival: one(festival, {
...
export const programmeNotificationRelations = relations(programmeNotification, ({one}) => ({
	festival: one(festival, {
...
export const programmeJudgeSessionRelations = relations(programmeJudgeSession, ({one}) => ({
	festival: one(festival, {
