...
export default function ResultsPage() {
  ...
  const topThree = MOCK_RESULTS.filter((r) => r.position <= 3).sort(
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-12 text-center">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Celebrating the achievements and outstanding performances of our
            ...
            <div className="flex justify-center items-end gap-4 h-64 mb-12 px-4">
              {[
                ...
                return (
                  ...
                  >
                    <Trophy
                      className={`w-8 h-8 mb-2 ${podium.pos === 1 ? "text-yellow-500" : "text-foreground/50"}`}
                    />
                    ...
                    <div className="mt-4 font-bold text-2xl opacity-25">
                      #{podium.pos}
                    </div>
                  </motion.div>
                );
