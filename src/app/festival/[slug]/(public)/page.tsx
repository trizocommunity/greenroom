...
export default async function FestivalPage({
  ...
  // Find active or latest edition to redirect to
  const activeEdition =
  ...
  const festivalData = {
    ...
    tagline: "", // Add tagline to schema if needed
    startDate: new Date().toISOString(),
    endDate: new Date().toISOString(),
    location: festival.orgLocation || "",
    status: festival.status, // "DRAFT" | "ACTIVE" mismatch with string? No, Model return is typed.
    accentColor: "#000000",
    activeEdition: null,
    logo: null,
    heroImage: null,
