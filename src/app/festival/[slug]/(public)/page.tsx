...
import { findFestivalBySlugWithCounts } from "@/models/FestivalModel";
...
export default async function FestivalPage({
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      {festival.description && (
        <section className="py-24 px-4 bg-muted/20">
          <div className="max-w-3xl mx-auto text-center space-y-6">
            <span className="text-sm font-semibold tracking-wider text-muted-foreground uppercase">About the Event</span>
            <h2 className="text-3xl md:text-5xl font-bold tracking-tight">A Celebration of Culture</h2>
      ...
      <FeaturedPrograms accentColor={festival.accentColor} slug={festival.slug!} />
