import { findParticipantsByFestival } from "@/server/models/participant.model";
...
// import { PermissionGate } from "@/components/festival/PermissionGate"; // Removed
...
export default async function ParticipantsPage({
  ...
  const participants = await findParticipantsByFestival(festival.id);
  const currentCount = participants.length;
  // TODO: Festival Limits check
