...
export default async function EmailSettingsPage() {
	...
	return (
		<div className="space-y-6">
			<div>
				<h2 className="text-3xl font-semibold tracking-tight">Email settings</h2>
				<p className="text-muted-foreground">
					Globally enable or disable each kind of transactional email the
					platform sends. Disabled kinds are silently skipped at send time —
					the caller still receives a success result with{" "}
				...
				<CardHeader>
					<div className="flex items-center gap-3">
						...
						<div>
							...
							<CardDescription>
								Each row is one transactional email kind. Toggle off to stop
								the platform from sending it. Default is on.
							</CardDescription>
						</div>
					</div>
				</CardHeader>
