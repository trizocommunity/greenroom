...
import { createStudentAsTeamLeaderAction } from "@/features/participants/actions/participant-student.actions";

const TeamLeaderStudentSchema = z.object({
...
type TeamLeaderStudentFormValues = z.infer<typeof TeamLeaderStudentSchema>;
...
export function AddStudentDialog({
  ...
  const form = useForm<TeamLeaderStudentFormValues>({
    resolver: zodResolver(TeamLeaderStudentSchema as any),
    mode: "onChange",
    defaultValues: {
      name: "",
      email: "",
  ...
  const onSubmit = async (data: TeamLeaderStudentFormValues) => {
    setIsLoading(true);
    try {
      await createStudentAsTeamLeaderAction(festivalId, data);
      ...
      <DrawerContent className="p-0 sm:p-0 gap-0">
        <div className="mx-auto w-full max-w-2xl flex flex-col h-full overflow-hidden">
          <DrawerHeader className="shrink-0 p-4 sm:p-6 pb-2 border-b">
            ...
            <DrawerDescription>
              Add a new student to your team.
            </DrawerDescription>
          </DrawerHeader>
