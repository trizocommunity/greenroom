...
/** The portal is used one-handed beside a stage, so it stays narrow. */
...
export function StagePortalHomeClient() {
  ...
  if (scoring) {
    return (
      <div className={cn(PORTAL_CONTAINER, "pt-6 sm:pt-10")}>
  ...
  return (
    <div className={cn(PORTAL_CONTAINER, "pb-16 pt-6 sm:pt-10")}>
      ...
      {/* The live programme — the only thing on this screen that can be acted on */}
      {isLoading ? (
      ...
      <section className="mt-10">
        <div className="mb-3 flex items-baseline justify-between gap-3">
          <h2 className="text-[11px] font-semibold uppercase tracking-[0.18em] text-muted-foreground">
            {selectedDay ? dayLabel(selectedDay) : "Today"}
          </h2>
