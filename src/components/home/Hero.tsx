      ...
      <div className="container max-w-7xl px-4 md:px-6 relative z-10 flex flex-col items-center text-center">
        ...
        >
          <Link href="/contact">
            <Button
              size="lg"
              className="h-14 px-10 text-lg uppercase font-bold tracking-wider rounded-none border-2 border-primary hover:bg-transparent hover:text-primary transition-all"
            >
          ...
          <Link href="/contact">
            <Button
              variant="outline"
              size="lg"
              className="h-14 px-10 text-lg uppercase font-bold tracking-wider rounded-none border-2 border-white/20 hover:border-white hover:bg-white hover:text-black transition-all"
            >
              Contact Us
            </Button>
          </Link>
