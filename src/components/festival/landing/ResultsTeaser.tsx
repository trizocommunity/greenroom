        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
                ...
                <p className="text-lg text-muted-foreground mb-8 text-pretty">
                    The results are rolling in! Witness the triumphs and celebrations as teams compete for the championship.
                </p>
                <Link href={`/festival/${slug}/results`}>
                    <Button size="lg" className="rounded-full" style={{ backgroundColor: accentColor }}>
            ...
            <div className="grid gap-4">
                ...
                {topResult && (
                    ...
                    >
                        ...
                        <div className="relative">
                            <span className="text-sm font-medium text-muted-foreground">{topResult.programName}</span>
                            <h3 className="text-2xl font-bold mt-1 mb-2">Winner: {topResult.winner}</h3>
                            <p className="font-medium text-lg" style={{ color: accentColor }}>{topResult.team}</p>
                        </div>
                    </motion.div>
                )}
                ...
                {runnersUp.map((result, i) => (
                    ...
                    >
                        <div>
                            <p className="text-xs text-muted-foreground mb-1">{result.programName}</p>
