...
import { Shield, Crown, User, Gavel, Mic2, UsersRound } from "lucide-react";
...
export function FestivalRoleBadge({ role, className, variant = "outline" }: FestivalRoleBadgeProps) {
  ...
  return (
    <Badge variant={variant} className={`font-normal whitespace-nowrap ${config.className} ${className}`}>
